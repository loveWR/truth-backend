...
function(a) {
    ...
    a.fn.transform = function(a) {
        var b, c;
        for (b = 0; b < this.length; b++) c = this[b].style,
        c.webkitTransform = c.MsTransform = c.msTransform = c.MozTransform = c.OTransform = c.transform = a;
        return this
    },
    a.fn.transition = function(a) {
        var b, c;
        for ("string" != typeof a && (a += "ms"), b = 0; b < this.length; b++) c = this[b].style,
...
function(a) {
    ...
    var e, c = function(b, c) {
        var e, f;
        c = c || "",
        a("<div class='weui_mask_transparent'></div>").appendTo(document.body),
        e = '<div class="weui_toast ' + c + '">' + b + "</div>",
        f = a(e).appendTo(document.body),
        f.show(),
        f.addClass("weui_toast_visible")
    },
    d = function() {
        a(".weui_mask_transparent").hide(),
    ...
    a.toast = function(a, b) {
        var f;
        "cancel" == b ? f = "weui_toast_cancel": "forbidden" == b && (f = "weui_toast_forbidden"),
        c('<i class="weui_icon_toast"></i><p class="weui_toast_content">' + (a || "已经完成") + "</p>", f),
        setTimeout(function() {
            d()
        },
        e.duration)
    ...
    a.showLoading = function(a) {
        ...
        b += "</div>",
        b += '<p class="weui_toast_content">' + (a || "数据加载中") + "</p>",
        c(b, "weui_loading_toast")
    },
...
function(a) {
    ...
    a.modal = function(c) {
        ...
        f = '<div class="weui_dialog"><div class="weui_dialog_hd"><strong class="weui_dialog_title">' + c.title + "</strong></div>" + (c.text ? '<div class="weui_dialog_bd">' + c.text + "</div>": "") + '<div class="weui_dialog_ft">' + e + "</div>" + "</div>",
        g = a.openModal(f),
        g.find(".weui_btn_dialog").each(function(b, e) {
            var f = a(e);
            f.click(function() {
                c.autoClose && a.closeModal(),
                d[b].onClick && d[b].onClick()
            })
        })
    },
    a.openModal = function(b) {
        ...
        return c.show(),
        d = a(b).appendTo(document.body),
        d.show(),
        c.addClass("weui_mask_visible"),
        d.addClass("weui_dialog_visible"),
        d
    },
    ...
    a.alert = function(c, d, e) {
        return "function" == typeof d && (e = arguments[1], d = void 0),
        a.modal({
            text: c,
            title: d,
            buttons: [{
    ...
    a.confirm = function(c, d, e, f) {
        return "function" == typeof d && (f = arguments[2], e = arguments[1], d = void 0),
        a.modal({
            text: c,
            title: d,
            buttons: [{
    ...
    a.textarea = function(c, d, e, f) {
        return "function" == typeof d && (f = arguments[2], e = arguments[1], d = void 0),
        a.modal({
            text: "<p class='weui-prompt-text'>" + (c || "") + "</p><textarea class='mytextarea' rows='5' ></textarea>",
            title: d,
            buttons: [{
                text: b.buttonCancel,
                className: "default",
